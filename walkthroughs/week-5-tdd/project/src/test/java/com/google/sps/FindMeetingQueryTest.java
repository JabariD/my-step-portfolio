...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredExceptOptionalEarlyandLateReturned() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void justEnoughRoomOptionalCreatesNoRoom() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----A----|
  ...
  public void noMandatoryAttendees() {
    // Two optional attendees with several gaps in their schedules. Those gaps should be identified and returned.
    //
    // Events  :  |--A--|    |--B--|
    // Day     : |---------------------|
    // Options :       |-----|
